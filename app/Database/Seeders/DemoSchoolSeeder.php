...
class DemoSchoolSeeder extends Seeder
{
    ...
    private function seedCampusAndAcademicYear(): void
    {
        ...
        $this->academicYear = AcademicYear::firstOrCreate(['title' => '2024-2025'], [
    ...
    private function seedFeeStructure(): void
    {
        ...
        $labType = FeeType::firstOrCreate(['name' => 'Lab Fee'], [
            'code'        => 'LAB',
            'description' => 'Monthly laboratory fee (Science classes)',
        ]);

        $compType = FeeType::firstOrCreate(['name' => 'Computer Lab Fee'], [
            'code'        => 'CMP',
            'description' => 'Monthly computer lab fee',
        ]);
            ...
            foreach ($feeMasters as $fm) {
                ...
                if ($index % 10 < 7) {
                    ...
                    $payment = FeePayment::firstOrCreate([
                        ...
                        'total_paisas'   => $fm->amount_paisas,
                        'payment_method' => $paymentMethods[array_rand($paymentMethods)],
                        'collector_id'   => $this->adminUser->id,
    ...
    private function seedExamsAndResults(): void
    {
        $midTerm = Exam::firstOrCreate(['name' => 'Mid-Term Examination 2024'], [
            ...
            'is_published'     => true,
            'published_at'     => Carbon::parse('2024-10-20'),
    ...
    {
        $leaveTypes = [
            ['name' => 'Casual Leave',     'days_allowed' => 12, 'applicable_to' => 'staff'],
            ['name' => 'Sick Leave',        'days_allowed' => 10, 'applicable_to' => 'staff'],
            ['name' => 'Earned Leave',      'days_allowed' => 15, 'applicable_to' => 'staff'],
            ['name' => 'Maternity Leave',   'days_allowed' => 90, 'applicable_to' => 'staff'],
            ['name' => 'Student Leave',     'days_allowed' => 30, 'applicable_to' => 'student'],
            ['name' => 'Medical Leave',     'days_allowed' => 15, 'applicable_to' => 'both'],
        ];
