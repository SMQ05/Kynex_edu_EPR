...
use App\Filament\SchoolAdmin\Widgets\Teacher\TeacherClassesWidget;
...
class Dashboard extends BaseDashboard
{
    ...
    {
        // The school-admin panel authenticates via the `school_users` guard, so
        // auth()->user() (default `web` guard) resolves to null and the match
        // below falls through to the default. Pull from the right guard.
