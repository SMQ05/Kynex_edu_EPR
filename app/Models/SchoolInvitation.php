...
class SchoolInvitation extends Model
{
    ...
    /**
     * SchoolInvitation rows live in the central database. Pin the
     * connection so queries from inside tenancy context (e.g. the
     * SchoolUser admin actions for "Send set-password" / "Send password
     * reset") don't try to read from the tenant DB.
     */
