...
<head>
    ...
    <title>500 - Server Error | KynexEdu</title>
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .error-code { font-size: 8rem; font-weight: 900; line-height: 1; background: linear-gradient(135deg, #ef4444, #dc2626); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
        ...
        .support { margin-top: 1.5rem; color: #64748b; font-size: 0.875rem; }
        .support a { color: #10b981; text-decoration: none; }
    </style>
</head>
<body>
    <div class="container">
