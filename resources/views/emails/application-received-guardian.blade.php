...
<title>Application Received for {{ $applicantName }} — {{ $schoolName }}</title>
<style>
...
<div class="wrapper">
  ...
  <div class="body">
    ...
    <p>
      Thank you for applying to <strong>{{ $schoolName }}</strong> on behalf of your child
      <strong>{{ $applicantName }}</strong>. We have successfully received the admission
      application and it is currently under review by our admissions team.
    </p>

    <div class="ref-box">
      <p class="label">Application Reference</p>
      <p class="value">{{ $referenceToken }}</p>
    </div>

    <p>Save this reference number — you can use it to check the application status at any time.</p>
    ...
    <div class="steps">
      ...
      <div class="step-row">
        ...
        <div class="step-text">Our admissions team will review the application. This usually takes 2–3 working days.</div>
      </div>
      <div class="step-row">
        <div class="step-num">2</div>
        <div class="step-text">If an entry test is required, your child will receive a separate email with their exam login credentials and schedule.</div>
      </div>
      <div class="step-row">
        <div class="step-num">3</div>
        <div class="step-text">Once a decision is made, you will be notified by email. If admitted, the admission letter will follow with further instructions.</div>
      </div>
    </div>

    <div class="info-row">📋 <span><strong>Applicant:</strong> {{ $applicantName }}</span></div>
