...
<title>Reset Your Password — KynexEdu</title>
<style>
  ...
  .note { background:#fef2f2; border-left:4px solid #ef4444; border-radius:4px; padding:14px 18px; margin:24px 0; font-size:13px; color:#7f1d1d; }
...
<div class="wrapper">
  ...
  <div class="body">
    ...
    <p>We received a request to reset your KynexEdu password. Click the button below to set a new password.</p>
    <div class="btn-wrap">
