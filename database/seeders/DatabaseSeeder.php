...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command->info('✅  3 Subscription Plans created.');

        // ── 3. Sample Tenant Signups (status = new) ─────────────
        TenantSignup::updateOrCreate(
            ['email' => 'principal@greenvalley.edu.pk'],
            [
                ...
                'city'          => 'Lahore',
                'country'       => 'Pakistan',
                'message'       => 'We are interested in the Growth plan for our 350-student school.',
                'status'        => SignupStatus::New,
            ],
        );

        TenantSignup::updateOrCreate(
            ['email' => 'admin@brightstarsacademy.pk'],
            [
                'school_name'   => 'Bright Stars Academy',
                'contact_name'  => 'Fatima Zahra',
                'phone'         => '+92-321-9876543',
                'city'          => 'Karachi',
                'country'       => 'Pakistan',
                'message'       => 'Looking for a comprehensive school management system for our 3 campuses.',
                'status'        => SignupStatus::New,
            ],
        );

        $this->command->info('✅  2 Sample Tenant Signups created.');
